		...
		<div class="row">
			<form method="post" action="writeAction2.jsp">
				<table class="table table-bordered" style="text-align: center;">
					...
					<tbody>
							<tr>
								<td colspan="2"><input type="text" class="form-control" placeholder="글 제목" name="bbsTitle2" maxlength="50"></td>
							</tr>
							<tr>
								<td colspan="2"><textarea class="form-control" name="bbsContent2" placeholder="글 내용" maxlength="2048" style="height: 350px;"></textarea></td>
							</tr>
					</tbody>
				</table>
